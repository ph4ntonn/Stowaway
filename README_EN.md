...
### Character
Stowaway can be excuted as three kinds of modes: 
- admin:   The node that the pentester can manipulate
- startnode:  startnode means the first node that connecting to admin,it's different from simple nodes
- simple node:  common node that can be manipulated by admin
